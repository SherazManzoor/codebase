              ...
              <div className="relative px-6 lg:px-8 py-16 sm:py-8">
                ...
                <div className="pb-8">
                  <div className=" text-center space-x-8">
                    <button className="border-violet-500 text-gray-900 inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium">
                      Files
                    </button>
                ...
                <div className="max-w-md m-auto">
                  <div>
                    ...
                    <div
                      ...
                      onClick={handleFileClick} // Call the function to trigger file selection when clicking anywhere in the flex container
                    >
                      <input
                        ref={fileInputRef} // Set a ref on the input element
