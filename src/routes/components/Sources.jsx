                            ...
                            <div className="relative px-6 lg:px-8 py-16 sm:py-8">
                                ...
                                <div className="pb-8">
                                    <div className=" text-center space-x-8">
                                        <button onClick={
                                                () => handleTypeChange("files")
                                            }
                                            className={
                                                `${
                                                    selectedType === "files" ? "border-violet-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                        ...
                                        <button onClick={
                                            ...
                                            className={
                                                `${
                                                    selectedType === "text" ? "border-violet-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                                } inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium`
                                        }>
                                            Text
                                        </button>
                                        <button onClick={
                                            ...
                                            className={
                                                `${
                                                    selectedType === "website" ? "border-violet-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                                } inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium`
                                        }>
                                            Website
                                        </button>
                                        <button onClick={
                                                () => handleTypeChange("qna")
                                            }
                                            className={
                                                `${
                                                    selectedType === "qna" ? "border-violet-500 text-gray-900" : "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700"
                                                } inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium`
                                        }>
                                            Q&A
                                        </button>
                                ...
                                selectedType === "website" && (
                                    <div className="max-w-3xl m-auto">
                                        {/* Website content */}
                                        <label htmlFor="" className="block text-sm font-medium leading-6 text-gray-900 my-2">
                                            Crawl
                                        </label>
                                        <div className="relative mt-2 rounded-md">
                                            <div className="flex space-x-2">
                                                <input type="text" name="website" className=" flex-auto rounded-md border-0 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6" placeholder="https://www.example.com"/>
                                        ...
                                        <div>
                                            <label htmlFor="sitemap" className="block text-sm font-medium leading-6 text-gray-900 my-2">
                                                Submit Sitemap
                                            </label>
                                            <div className="relative mt-2 rounded-md ">
                                                <div className="flex space-x-2">
                                                    <input type="text" className=" flex-auto rounded-md border-0 py-1.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-violet-500 sm:text-sm sm:leading-6" placeholder="https://www.example.com/sitemap.xml"/>
                                                    <div className="flex justify-center">
                                                        <a style={
                                                                {backgroundColor: "black"}
                                                            }
                                        ...
                                        <div className="mt-16">
                                                ...
                                                <div key={index}
                                                    ...
                                                    <div className="flex items-center">
                                                        ...
                                                        <button type="button" className="text-zinc-600 hover:text-zinc-900"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4 text-red-600 ml-1">
                                            ...
                                            <div className="my-2 flex justify-end">
                                                <button type="button" className="flex items-center rounded-md border border-transparent bg-zinc-200 py-1 px-2 text-sm font-medium text-black shadow-sm hover:bg-zinc-300"
                                            ...
                                            qna.map((qna, index) => (
                                                <>
                                                    <div key={index}
                                                        className="relative mt-2 rounded-md shadow-sm">
                                                        <div>
                                                            <label htmlFor="" className="mt-8 text-sm text-zinc-700">
                                                                Questions
                                                            </label>
                                                            <textarea className="min-w-0 p-1 w-full appearance-none rounded-md border border-zinc-900/10 bg-white px-3 shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-4 focus:ring-violet-500/10 sm:text-sm text-gray-900" rows="3"></textarea>
                                                        </div>
                                                        <div>
                                                            <label htmlFor="" className="mt-8 text-sm text-zinc-700">
                                                                Answer
