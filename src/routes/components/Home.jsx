                ...
                <div className="relative px-6 lg:px-8 py-16 sm:py-8">
                  ...
                  <div id="video" className="py-16">
                    ...
                    <p className="text-center pb-4">
                      ...
                      by crawling the website and training the AI on its
                      content. I can then embed the chatbot on the website!
                    </p>
                      ...
                      <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-20 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
                        ...
                        <div className="space-y-8 xl:contents xl:space-y-0">
                          ...
                          >
                            ...
                            />
                            <p className="font-semibold text-center">
                              Connect your chatbot to a Slack channel and
                        ...
                        <ul role="list" className="flex flex-col gap-y-8">
                          <li>
                            ...
                            <p className="mt-4 text-slate-700">
                              Chatbase is an AI chatbot builder, it trains
                              ChatGPT on your data and lets you add a chat
                              widget to your website. Just upload a document or
                              add a link to your website and get a chatbot that
                          ...
                          <li>
                            ...
                            <p className="mt-4 text-slate-700">
                              ...
                              (.pdf, .txt, .doc, .docx), paste text, or add a
                              link to your website to be scraped.
                            </p>
                          </li>
                          <li>
                            <h3 className="font-display text-lg leading-7 text-slate-900">
                            ...
                            <p className="mt-4 text-slate-700">
                              ...
                              chatbot a name, personality traits and
                              instructions on how to answer questions ex. (only
                              answer in French).
                            </p>
                          </li>
                          <li>
                      ...
                      <li>
                        <ul role="list" className="flex flex-col gap-y-8">
                          <li>
                            ...
                            <p className="mt-4 text-slate-700">
                              By default your chatbot uses gpt-3.5-turbo (but
                              you have the option to use gpt-4 on the Standard
                              and Unlimited plans).
                            </p>
                          </li>
                          <li>
                            ...
                            <p className="mt-4 text-slate-700">
                              You can embed an iframe or add a chat bubble to
                              the bottom right of your website. To do that,
                              create a chatbot and click &quot;Embed on website
                              &quot;. You can also use the API to communicate
                              with your chatbot anywhere!
                            </p>
                          </li>
                          <li>
                            <h3 className="font-display text-lg leading-7 text-slate-900">
                          ...
                          <li>
                            ...
                            <p className="mt-4 text-slate-700">
                              ...
                              but you can change the setting to make it public
                      ...
                      <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-4 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
                        <figure className="col-span-2 hidden sm:block sm:rounded-2xl sm:bg-white sm:shadow-lg sm:ring-1 sm:ring-gray-900/5 xl:col-start-2 xl:row-end-1">
                          ...
                          <blockquote className="p-10 text-xl font-semibold leading-8 tracking-tight text-gray-900">
                            <p>
                              “For anyone on the fence - in the 2 hours since
                              this tweet I &#x27;ve tested, set up and gone live
                              on three separate websites with Chatbase. Still
                              need to do some light tweaking of the base prompt
