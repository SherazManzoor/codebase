                            ...
                            <div className="p-5">
                              <div className="pb-8">
                                ...
                                <div className="mt-1">
                                  <textarea
                                    ...
                                    className="min-w-0 p-1 flex-auto w-full appearance-none rounded-md border border-zinc-900/10 bg-white px-3 placeholder:text-zinc-400 focus:border-violet-500 focus:outline-none focus:ring-4 focus:ring-violet-500/10 sm:text-sm text-gray-900"
                                  >
                                    I want you to act as a document that I am
                                    having a conversation with. Your name is "AI
                                    Assistant". You will provide me with answers
                                    from the given info. If the answer is not
                                    included, say exactly "Hmm, I am not sure."
                                    and stop after that. Refuse to answer any
                                    question not about the info. Never break
                                    character.
                                  </textarea>
                                </div>
                              </div>
                              <div className="pb-8">
                                ...
                                <p className="mt-2 text-sm text-zinc-500">
                                  1 message using gpt-3.5-turbo costs 1 message
                                  credit. 1 message using gpt-4 costs 20 message
                                  credits.
                                </p>
                              </div>
                              <div>
                          ...
                          <div className="border border-gray-200 rounded mb-10">
                            ...
                            <div className="p-5">
                              <div className="pb-8">
                                ...
                                <p className="mt-2 text-sm text-zinc-500">
                                  'private': No one can access your chatbot
                                  except you (your account)
                                </p>
                                <p className="mt-2 text-sm text-zinc-500">
                                  'can be embedded on website': Other people can
                                  chat with your chatbot if you send them the
                                  link. You can also embed it on your website so
                                  your website visitors are able to use it.
                                </p>
                              </div>
                              <div className="pb-8">
                                <div>
                                  ...
                                  {showDomain && (
                                    <>
                                      ...
                                      <div className="mt-1">
                                        ...
                                        <p className="mt-2 text-sm text-zinc-500">
                                          Domains you want to embed your chatbot
                                          on. Your chatbot visibility has to be
                                          'can be embedded on website' for this
                                          to work.
                                        </p>
                                      </div>
                                    </>
                            ...
                            <div>
                              <div className="p-5">
                                <div className="pb-8">
                                  ...
                                  <p className="mt-2 text-sm text-zinc-500">
                                    Limit the number of messages sent from one
                                    device on the iframe and chat bubble (this
                                    limit will not be applied to you on
                                    chatbase.co, only on your website for your
                              ...
                              <div className=" flex justify-between lg:space-x-8 flex-col lg:flex-row">
                                <div className="flex-1 w-2/2 lg:w-1/2 pb-5">
                                  ...
                                  <p className="text-sm text-zinc-900 pb-10">
                                    **If the changes here don &#x27;t show up
                                    immediately on your website try clearing
                                    your browser cache or use incognito. (New
