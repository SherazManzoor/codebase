          ...
          >
            <div class=" w-full flex justify-between items-center">
              <div class="flex items-center">
                ...
                <p class="sm:text-sm text-xs text-left ">Add to Messenger</p>
              </div>
              <span class="text-zinc-600 text-xs ml-4">Coming Soon...</span>
            </div>
          </button>
          <div class="w-8 h-6"></div>
        </div>
        <div class="w-full flex justify-center items-center mb-4">
                                    <button aria-label="Zapier" disabled="" class="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   cursor-not-allowed text-zinc-600">
                                        <div class=" w-full flex justify-between items-center">
                                            <div class="flex items-center">
                                                <div class="sm:w-8 md:w-8 w-5 mr-7">
                                                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#52525B">
                                                        <title>Zapier</title>
                                                ...
                                                <p class="sm:text-sm text-xs text-left ">Add to Zapier</p>
                                            </div>
                                            <span class="text-zinc-600 text-xs ml-4">Coming Soon...</span>
                                        </div>
                                    </button>
                                ...
                                <div class="w-full flex justify-center items-center mb-4">
                                    <button aria-label="Wordpress" disabled="" class="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   cursor-not-allowed text-zinc-600">
                                        <div class=" w-full flex justify-between items-center">
                                            <div class="flex items-center">
                                                <div class="sm:w-8 md:w-8 w-5 mr-7">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="#52525B" class="bi bi-wordpress" viewBox="0 0 16 16">
                                                        ...
                                                        <path fill-rule="evenodd" d="M0 8c0-4.411 3.589-8 8-8 4.41 0 8 3.589 8 8s-3.59 8-8 8c-4.411 0-8-3.589-8-8zm.367 0c0 4.209 3.424 7.633 7.633 7.633 4.208 0 7.632-3.424 7.632-7.633C15.632 3.79 12.208.367 8 .367 3.79.367.367 3.79.367 8z"></path>
                                                    </svg>
                                                </div>
                                                <p class="sm:text-sm text-xs text-left ">Add to Wordpress</p>
                                            </div>
                                            <span class="text-zinc-600 text-xs ml-4">Coming Soon...</span>
                                        </div>
                                    </button>
                                ...
                                <div class="w-full flex justify-center items-center mb-4">
                                    <button aria-label="Shopify" disabled="" class="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   cursor-not-allowed text-zinc-600">
                                        <div class=" w-full flex justify-between items-center">
                                            <div class="flex items-center">
                                                <div class="sm:w-8 md:w-8 w-5 mr-7">
                                                    <svg viewBox="-18 0 292 292" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                            <path d="M223.774 57.34c-.201-1.46-1.48-2.268-2.537-2.357-1.055-.088-23.383-1.743-23.383-1.743s-15.507-15.395-17.209-17.099c-1.703-1.703-5.029-1.185-6.32-.805-.19.056-3.388 1.043-8.678 2.68-5.18-14.906-14.322-28.604-30.405-28.604-.444 0-.901.018-1.358.044C129.31 3.407 123.644.779 118.75.779c-37.465 0-55.364 46.835-60.976 70.635-14.558 4.511-24.9 7.718-26.221 8.133-8.126 2.549-8.383 2.805-9.45 10.462C21.3 95.806.038 260.235.038 260.235l165.678 31.042 89.77-19.42S223.973 58.8 223.775 57.34zM156.49 40.848l-14.019 4.339c.005-.988.01-1.96.01-3.023 0-9.264-1.286-16.723-3.349-22.636 8.287 1.04 13.806 10.469 17.358 21.32zm-27.638-19.483c2.304 5.773 3.802 14.058 3.802 25.238 0 .572-.005 1.095-.01 1.624-9.117 2.824-19.024 5.89-28.953 8.966 5.575-21.516 16.025-31.908 25.161-35.828zm-11.131-10.537c1.617 0 3.246.549 4.805 1.622-12.007 5.65-24.877 19.88-30.312 48.297l-22.886 7.088C75.694 46.16 90.81 10.828 117.72 10.828z" fill="#52525B"></path>
                                                            <path d="M221.237 54.983c-1.055-.088-23.383-1.743-23.383-1.743s-15.507-15.395-17.209-17.099c-.637-.634-1.496-.959-2.394-1.099l-12.527 256.233 89.762-19.418S223.972 58.8 223.774 57.34c-.201-1.46-1.48-2.268-2.537-2.357" fill="#52525B"></path>
                                                ...
                                                <p class="sm:text-sm text-xs text-left ">Add to Shopify</p>
                                            </div>
                                            <span class="text-zinc-600 text-xs ml-4">Coming Soon...</span>
                                        </div>
                                    </button>
                                ...
                                <div class="w-full flex justify-center items-center mb-4">
                                    <button aria-label="Whatsapp" disabled="" class="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   cursor-not-allowed text-zinc-600">
                                        <div class=" w-full flex justify-between items-center">
                                            <div class="flex items-center">
                                                <div class="sm:w-8 md:w-8 w-5 mr-7">
                                                    <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <g id="SVGRepo_iconCarrier">
                                                            ...
                                                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <g id="Dribbble-Light-Preview" transform="translate(-300.000000, -7599.000000)" fill="#52525B">
                                                ...
                                                <p class="sm:text-sm text-xs text-left ">Add to Whatsapp</p>
                                            </div>
                                            <span class="text-zinc-600 text-xs ml-4">Coming Soon...</span>
                                        </div>
                                    </button>
