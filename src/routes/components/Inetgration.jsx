    ...
    <div>
      <div className="mt-5 flex flex-col justify-center items-center w-full">
        <div className="w-full flex justify-center items-center mb-4">
          <button
            aria-label="Slack"
            className="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   hover:bg-zinc-100"
          >
            <div className=" w-full flex justify-between items-center">
              <div className="flex items-center">
                <div className="sm:w-8 md:w-8 w-5 mr-7">
                  <svg
                ...
                <p
                  ...
                  className="sm:text-sm text-xs text-left "
                >
                  {t("Add to Slack workspace")}
                </p>
              </div>
              <a
                className="text-zinc-600 text-xs ml-4 hover:underline"
                href="/pricing"
              >
        ...
        <div className="w-full flex justify-center items-center mb-4">
          <button
            ...
            disabled=""
            className="md:w-3/6 w-5/6 bg-white border px-5 py-3  rounded-2xl flex items-center   cursor-not-allowed text-zinc-600"
          >
            <div className=" w-full flex justify-between items-center">
              <div className="flex items-center">
                <div className="sm:w-8 md:w-8 w-5 mr-7">
              ...
              <span className="text-zinc-600 text-xs ml-4">
                {t("Coming Soon")}
              </span>
            </div>
          </button>
